...
export const NAV_ITEMS = {
  [ROLES.SUPER_ADMIN]: [
    ...
    { key: "website", label: "Website", path: "/admin/website" },
    { key: "calendar", label: "Calendar", path: "/admin/calendar" },
    { key: "import", label: "Bulk import", path: "/admin/import" },
    { key: "audit", label: "Audit log", path: "/admin/audit" },
    { key: "backup", label: "Backup", path: "/admin/backup" },
    { key: "recycle", label: "Recycle bin", path: "/admin/recycle" },
    { key: "help", label: "Help guides", path: "/admin/help" },
  ...
  [ROLES.TEACHER]: [
    ...
    { key: "queue", label: "Grading queue", path: "/teacher/queue" },
    { key: "calendar", label: "Calendar", path: "/teacher/calendar" },
    { key: "attendance", label: "Attendance", path: "/teacher/attendance" },
    { key: "appeals", label: "Appeals", path: "/teacher/appeals" },
    { key: "templates", label: "Templates", path: "/teacher/templates" },
    { key: "comments", label: "Comment bank", path: "/teacher/comments" },
    { key: "help", label: "Help", path: "/teacher/help" },
    { key: "rubric", label: "Rubric", path: "/teacher/rubrics" },
  ...
  [ROLES.STUDENT]: [
    ...
    { key: "deadlines", label: "My deadlines", path: "/student/deadlines" },
    { key: "calendar", label: "Calendar", path: "/student/calendar" },
    { key: "attendance", label: "Attendance", path: "/student/attendance" },
    { key: "transcript", label: "Transcript", path: "/student/transcript" },
    { key: "appeals", label: "Appeals", path: "/student/appeals" },
    { key: "help", label: "Help", path: "/student/help" },
...
export const MODULE_CATALOG = {
  teacher: [
    ...
    { key: "comments", label: "Comment bank" },
    { key: "queue", label: "Grading queue" },
  ...
  student: [
    ...
    { key: "appeals", label: "Appeals" },
    { key: "help", label: "Help" },
    { key: "deadlines", label: "My deadlines" },
  ],
};
